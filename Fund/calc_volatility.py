...
if __name__ == '__main__':
    ...
    # do_work('2017', '2019')
    # do_work('2018', '2020')
    calc_recent_year(2019)
    calc_recent_year(2018)
    calc_recent_year(2017)
    calc_recent_year(2016)
    calc_recent_year(2015)
    calc_recent_year(2014)
    calc_recent_year(2013)
    calc_recent_year(2012)
    calc_recent_year(2011)
    calc_recent_year(2010)
    calc_recent_year()
